...
def show_classifier_page():
    ...
    Longitude = st.number_input('Insert a Longitude',max_value=-122.364937,min_value=-122.513642,step=0.001,format="%.6f")
    Latitude = st.number_input('Insert a Latitude',max_value=37.8206208380702,min_value=37.7078790224135,step=0.001,format="%.6f")
